...
<div class="container" style="margin-top: 100px;">
    ...
    <div class="section-header">
        <h1 class="section-title">✏️ Edit Book</h1>
        <p class="section-subtitle">Update the book information and files</p>
    </div>
...
@endforeach
    ...
    <div class="form-container">
        <form action="{{ route('updateBook', $book->id) }}" method="POST" enctype="multipart/form-data" class="modern-form">
        @csrf
        @method('PUT')
        ...
        @enderror
            ...
            <div class="form-group">
                ...
                <textarea name="desc" id="desc" class="form-textarea" 
                          ...
                          rows="5" required>{{ old('desc', $book->desc) }}</textarea>
                @error('desc')
                    <span class="error-message">{{ $message }}</span>
            @enderror
            </div>
        ...
        @if($book->image)
                        <div class="current-image">
                            <img src="{{ asset('storage/' . $book->image) }}" alt="Current cover" class="preview-image">
        ...
        @if($book->file_path)
                        <div class="current-file">
                            ...
                            <a href="{{ asset('storage/' . $book->file_path) }}" target="_blank" class="current-file-link">
                                {{ basename($book->file_path) }}
                            </a>
                            <span class="current-label">Current PDF</span>
                        </div>
        @endif
                    ...
                    <div class="file-upload-container">
                        ...
                        <div class="file-upload-area" id="pdfPreview">
                            ...
                            <p>Click to upload new PDF file</p>
