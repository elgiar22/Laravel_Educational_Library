...
@section('title', 'Create New Category - Digital Library')

@section('content')
<div class="container" style="margin-top: 100px;">
    <div class="section-header">
        <h1 class="section-title">📂 Create New Category</h1>
        <p class="section-subtitle">Organize your books with well-defined categories</p>
    </div>
    ...
    <div class="form-container">
        <form action="{{ route('storeCategory') }}" method="POST" enctype="multipart/form-data" class="modern-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-input" 
                       value="{{ old('name') }}" 
                       placeholder="Enter category name (e.g., Mathematics, Literature, Science)..."
                       required>
                @error('name')
            ...
            <div class="form-group">
                ...
                <textarea name="desc" id="desc" class="form-textarea" 
                          placeholder="Describe what this category is about and what types of books it will contain..."
